/*
******************************************************************
**       Measuring time for Bruteforcing AES (24bit)
**       For CBNU 2019 Information Security Class          
**       Origin AES By Niyaz PK     
**       A little modified By alkyne
key = AB CD AB CD AB CD AB CD AB CD AB CD 12 34 56 78
plaintxt = JungBoBoHo Gazua
plaintxt (hexencoded) = 4a 75 6e 67 42 6f 42 6f 48 6f 20 47 61 7a 75 61
...
unsigned char in[] = {0x4a,0x75,0x6e,0x67,0x42,0x6f,0x42,0x6f,0x48,0x6f,0x20,0x47,0x61,0x7a,0x75,0x61};
unsigned char out[16], state[4][4];
// The array that stores the round keys.
unsigned char RoundKey[240];
// The Key input to the AES Program
unsigned char Key[] = {0xAB,0xCD,0xAB,0xCD,0xAB,0xCD,0xAB,0xCD,0xAB,0xCD,0xAB,0xCD,0x12,0x34,0x56,0x78};
...
int main()
{
    ...
    // Measuring time for 24bit AES bruteforcing !
    uint32_t a = 0;
    ...
    printf("\n\n24 bit AES Brute-forcing takes %llu sec(s)\n", t2-t1);
    printf("\n\n");
    return 0;
}